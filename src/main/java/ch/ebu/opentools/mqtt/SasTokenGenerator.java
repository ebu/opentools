...
public class SasTokenGenerator
{
            ...
            throws InvalidKeyException
    {
        ...
        String token = String.format("SharedAccessSignature sr=%s&sig=%s&se=%s&skn=iothubowner", deviceUri, signature, String.valueOf(tokenExpirationTime) );
    ...
    public static String getHost(String uri) {
        ...
        String returnUri = aURI.getHost();
        return (returnUri == null ? "" : returnUri);
    }
}
